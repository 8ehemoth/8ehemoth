...
### Undergraduate Researcher | ISOL Lab
- Worked on CAN IDS anomaly detection research based on Hailo-8 and Raspberry Pi environments
- Built inference environments, checked input formats, compared results, and analyzed abnormal cases
- Explored automotive communication security topics including SOME/IP and anomaly detection pipelines

### Winter Internship
- Participated in hands-on engineering training during winter term
