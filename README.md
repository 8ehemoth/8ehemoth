...
![header](https://capsule-render.vercel.app/api?type=waving&height=200&text=Behemoth%20&fontAlign=80&fontAlignY=40&color=gradient)
...
![Hailo AI](https://img.shields.io/badge/Hailo%20AI-FF6F00?style=for-the-badge&logo=ai&logoColor=white)
...
- Built inference environments, validated input formats, compared results, and analyzed abnormal cases
- Explored automotive communication security topics including SOME/IP and anomaly detection pipelines
- Performed SOME/IP protocol analysis and LLM-assisted fuzzing experiments for automotive communication testing

### Winter Internship (Jan 2025 – Feb 2025)
- Participated in hands-on engineering training during the winter term
- Expanded practical understanding of embedded systems and hardware/software integration
- Strengthened experience in development environment setup, debugging, and real-device testing

### AI Club (Sep 2024 – Dec 2024)
